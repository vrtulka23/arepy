...
class propertiesComplex:
    ...
    def property_MassCenter(self,prop,ids=None):
    ...
    def property_AngularMomentum(self,prop,ids=None):
    ...
    def property_VolumeFraction(self,prop,ids=None):
    ...
    def property_RadHistogram(self,prop,ids=None):
    ...
    def property_BoxHistogram(self,prop,ids=None):
    ...
    def property_Histogram1D(self,prop,ids=None):
        return self._propHistogram(prop,ids)
    def property_Histogram2D(self,prop,ids=None):
        return self._propHistogram(prop,ids)
    ...
    def property_BoxPoints(self,prop,ids=None):
    ...
    def property_BoxLine(self,prop,ids=None):
    ...
    def property_BoxProjCube(self,prop,ids=None):
        import scipy.spatial as spatial
    ...
    def property_GridRegion(self,prop,ids=None):
    ...
    def property_RadialRegion(self,prop,ids=None):
        return self._propRegion(prop,ids)
    def property_BoxRegion(self,prop,ids=None):
        return self._propRegion(prop,ids)
    def property_IDsRegion(self,prop,ids=None):
        return self._propRegion(prop,ids)

    def property_ConeRegion(self,prop,ids=None):
        transf = prop['transf']
        center = transf['select']['center']
        radius = transf['select']['radius']
    ...
    def property_Maximum(self,prop,ids=None):
        return self._propStats(prop,ids)
    def property_Minimum(self,prop,ids=None):
        return self._propStats(prop,ids)
    def property_Mean(self,prop,ids=None):
        return self._propStats(prop,ids)
    def property_MinPos(self,prop,ids=None):
        return self._propStats(prop,ids)
    def property_Sum(self,prop,ids=None):
        return self._propStats(prop,ids)
